...
Parameter('pR_0'       , 1000);  # TRAIL receptor (for experiments not involving siRNA)
Parameter('flip_0'     , 2e3);  # Flip
Parameter('pC8_0'      , 1e4);  # procaspase-8 (pro-C8)
...
Parameter('Bid_0'      , 6e4);  # Bid
Parameter('Bcl2c_0'    , 3e4);  # cytosolic Bcl-2
Parameter('Bax_0'      , 8e4);  # Bax
Parameter('Bcl2_0'     , 3e4);  # mitochondrial Bcl-2
