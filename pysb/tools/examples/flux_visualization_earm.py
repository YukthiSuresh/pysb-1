...
f = open('/home/oscar/home/oscar/Documents/tropical_project/parameters_5000/pars_embedded_2415.txt')
data = csv.reader(f)
parames = [float(i[1]) for i in data]
tspan = np.linspace(0, 20160, 100)
run_visualization(model, tspan, parameters=parames, render_type='flux', save_video=False)
