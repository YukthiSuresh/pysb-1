# -*- coding: utf-8 -*-
#
# pysb documentation build configuration file, created by
...
import pysb, pkg_resources

# The full version, including alpha/beta/rc tags.
release = pysb.__version__
# The short X.Y version.
version = pkg_resources.parse_version(release).base_version

del pysb, pkg_resources
...
latex_documents = [
  ('index', 'pysb.tex', u'pysb Documentation',
